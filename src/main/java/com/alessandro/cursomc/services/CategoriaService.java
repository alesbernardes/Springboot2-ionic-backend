...
import com.alessandro.cursomc.dto.CategoriaDTO;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		repo.deleteById(id);
			...
			throw new DataIntegrityException("Não é possivel excluir uma categoria que possui pridutos");
		}
	}
	public List<Categoria> finfAll(){
		return repo.findAll();
	}
